...
from portl.associations import (
    pool_device_table,
    pool_link_table,
    pool_user_table,
    job_device_table,
...
from portl.functions import fetch, fetch_all
from portl.models import Base
...
AbstractPool: Any = type(
    ...
    (Base,),
    {
        ...
        **{
            **{
                f"device_{property}": Column(Text(), default="")
            ...
            **{
                f"link_{property}": Column(Text(), default="")
