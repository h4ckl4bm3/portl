...
/**
 * Query librportl server.
 */
// eslint-disable-next-line
function queryLibrportl() {
    fCall("/inventory/query_librportl", "#librportl_form", function () {
        alertify.notify("Topology imported from Librportl.", "success", 5);
    });
}
...
(function () {
    doc("https://portl.readthedocs.io/en/latest/inventory/objects.html");
})();
