...
from portl.automation.functions import NAPALM_DRIVERS, NETMIKO_DRIVERS
from portl.models import MultipleObjectField, ObjectField
...
class LibrportlForm(FlaskForm):
    librportl_address = StringField(default="http://librportl.example.com")
    node_type = [subtype for subtype in device_subtypes.items()]
    librportl_type = SelectField(choices=node_type)
    librportl_token = PasswordField()
