...
from portl.functions import factory, fetch
...
def create_example_services() -> None:
    ...
    for service in (
            ...
            },
            {
                ...
                "direction": "get",
                "protocol": "scp",
                "source_file": "/media/sf_VM/portl/tests/file_transfer/a.bin",
                "destination_file": "/media/sf_VM/portl/tests/file_transfer/b.bin",
            ...
            },
            {
                ...
                "destination_path": "/media/sf_VM/portl/tests/file_transfer",
                "delete_archive": True,
                "delete_folder": True,
            },
            {
            ...
            [
                {
                    ...
                    "description": "Use GET ReST call on portl ReST API",
                    "username": "admin",
                    "password": "admin",
                    "waiting_time": 0,
                    "devices": devices,
