...
from portl.classes import classes
from portl.extensions import db
from portl.functions import factory, integrity_rollback, fetch, get_one
from portl.properties import parameters_public_properties
...
def create_default_services() -> None:
    ...
    for service in (
            ...
            },
            {
                ...
                "description": "Monitor portl cluster",
                "creator": admin,
            },
            {
                "type": "SwissArmyKnifeService",
