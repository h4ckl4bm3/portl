...
Three pools are created by default in portl:
...
A pool is automatically updated by portl:
...
Use a pool to restrict an portl user to a subset of objects
----------------------------------------------------------
...
All mechanisms and all pages in portl will be restricted to the objects of that pool for that particular user. The exception is Service and Workflows
