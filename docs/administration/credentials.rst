...
If you are using portl in production, you MUST set up a Hashicorp Vault to handle the storage of all credentials.
Refer to the Installation section for notes on how to setup and configure the properties of Hashicorp Vault.

User credentials
----------------

The portl user credentials can be used to authenticate to portl, as well as to authenticate to a network device.
