...
.. image:: /_static/base/portl.png
   :alt: portl Introduction
   :align: center
...
portl is built on the :guilabel:`Flask` Python framework and utilizes either a :guilabel:`SQLite` database, or a :guilabel:`PostgreSQL` database. It runs as a WSGI service behind your choice of HTTP server.
